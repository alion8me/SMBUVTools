...
bl_info = {
    "name": "SMB UV Tools",
    "description": "Addon adding convenient UV tools for Super Monkey Ball mapping",
    "author": "alion8me",
    "version": (1, 0),
    "blender": (2, 83, 9), 
...
CLASSES = [VIEW3D_OT_checker_FAQ, VIEW3D_OT_smart_FAQ]
...
def register():
    ...
    #register uv menu items
    bpy.types.VIEW3D_MT_uv_map.append(menu_func)
    
    print("Successfully registered {}".format(bl_info["name"]))
